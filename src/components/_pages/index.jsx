    ...
    render() {
        return <div className="main">
            ...
            <ul className="list-num">
                ...
                <li> - <span className="code">npm run isomorphic</span> run isomorphic application version use Koa (wor after production build or with webpack dev server)</li>
                <li> - <span className="code">npm run w</span> run webpack dev server with watcher</li>
                <li> - <span className="code">npm run test-w</span> run webpack dev server with watcher</li>
